package com.davidrevolt.qwitter.core.designsystem.components.pulltorefresh
...
fun PullToRefreshIndicator(
    ...
    Row(
        ...
        BasicText(
            text = stringResource(
                when {
                    state.isPullInProgress && state.contentOffset >= refreshTriggerPx -> R.string.release_to_refresh
                    state.isRefreshing -> R.string.refreshing
                    else -> R.string.pull_to_refresh
                }
            ),
